...
class _SplitState extends State<Split> {
  double get firstFraction => _fractionMap[widget.key]!;
  set firstFraction(double value) => _fractionMap[widget.key!] = value;
  ...
  void initState() {
    ...
    if (!_fractionMap.containsKey(widget.key)) {
      _fractionMap[widget.key!] = widget.initialFirstFraction;
    }
  }
